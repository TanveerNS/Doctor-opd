			...
			<div class="app-content">
				...
				<div class="main-content" style="margin:0 80px;">
					<div class="wrap-content container" id="container">
						...
						<div class="row">
						<button style="float:right;margin:10px;clear:both;"><a href="history.php">History &#8594;</a></button>
						</div>
						...
						<div class="row">
							...
							<div class="searchstyle-header">
								...
								<div class="col-sm-6">
									...
									<input type="date" name="sbyname" class="form-control" onChange="getsearchbyname(this.value);"></input>
								</div>
							</div>
						</div>
