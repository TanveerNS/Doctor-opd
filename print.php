...
?>
											...
											<tr>
												...
												<td style="width:90px;"><?php $date = strtotime($row['date']);
											...
											<tr>
												...
												<td style="padding-bottom:0;text-transform:capitalize;"><?php echo $row['name']; ?></td>
											...
											<tr>
												<th style="padding:0 8px; text-transform:capitalize;"">Address:</th>
